...
def init_data_and_model(project):
    ...
    test_result = '/home/yqx/Downloads/DesigniteJava-master/myData/'+ project +'/_method_ablation_.txt'
...
if __name__ == '__main__':
    ...
    model_index = 5
    modelNames = [' - GCN ',' - Trainsformer ',' Full Model ',' GCN => BiLSTM ',' Trainsformer => DNN ',' Trainsformer => BiLSTM ']
