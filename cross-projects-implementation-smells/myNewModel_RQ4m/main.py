...
def init_data_and_model(projectList):
    jsonFolderPathList = []
    for projectname in projectList:
        jsonFolderPathList.append('/home/yqx/Downloads/DesigniteJava-master/myData/'+ projectname +'/methods/rawjson')
...
def init_testdata_and_model(projectList_train, project_test):
    ...
    project_test = '/home/yqx/Downloads/DesigniteJava-master/myData/'+ project_test +'/methods/rawjson'
...
def train(trainlist):
    ...
    for epoch in epochs:
        ...
        for batch_index in tqdm(range(int(len(train_data)/args.batch_size))):
            ...
            iterations += 1
        if epoch>25:
            saveModelsPath = '/home/yqx/Downloads/DesigniteJava-master/myData/A_myModel_method_10_cross/myNewModel_RQ4m/models_new'
...
if __name__ == '__main__':
    ...
    if train_flag:
        ...
        savePath = '/home/yqx/Downloads/DesigniteJava-master/myData/'+project+'/methods'
        if aim==1:
        ...
        testlist = []
        testlist += open(trainLabelPath).readlines()
