...
def init_data_and_model(project):
    ...
    test_result = "/home/yqx/Downloads/DesigniteJava-master/myData/"+project+"/methods_result_.txt"
...
if __name__ == '__main__':
    ...
    model_index = 0
    modelNames = [' gcn_trainsformer_fusion ',' Dense(CNN) ',' BiLSTM+attention+token ']
