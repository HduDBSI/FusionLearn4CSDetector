...
def init_testdata_and_model(projectList_train, project_test):
    ...
    vocablen, metrilen = len(vocabdict), len(metricdict)
    print('vocablen, metrilen',vocablen, metrilen)
    project_test = '/home/yqx/Downloads/DesigniteJava-master/myData/'+ project_test +'/types/rawjson'
...
def train(trainlist):
    ...
    for epoch in epochs:
        ...
        #'''
        if epoch>25:
            saveModelsPath = '/home/yqx/Downloads/DesigniteJava-master/myData/A_myModel_10_cross/myNewModel_RQ4/models'
...
if __name__ == '__main__':
    ...
    if train_flag:
        ...
        savePath = '/home/yqx/Downloads/DesigniteJava-master/myData/'+project+'/types'
        if aim==1:
