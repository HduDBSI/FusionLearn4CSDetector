...
if __name__ == '__main__':
    ...
    record_file = open('result_10_cross_1.txt', 'a')
    for project in projectList:
        jsonFolderPathList_train = []
        jsonFolderPathList_test = []
        for projectname in projectList:
            if projectname != project:
                jsonFolderPathList_train.append("/home/yqx/Downloads/DesigniteJava-master/myData/"+projectname+"/types/rawjson")
            else:
                jsonFolderPathList_test.append("/home/yqx/Downloads/DesigniteJava-master/myData/"+projectname+"/types/rawjson")
